...
public class Piegeur extends Personnage{
	 ...
	 */
	public void pieger(Island i, int posX, int posY){
		if(i.ile[posX][posY].getValeur()==8){
			i.ile[posX][posY].setValeur(16);		
		}		
		energie-=5;
	}
	/**
	 ...
	 * @param posY position Y voulue
	 */
	public void desarmerPiege(Island i, int posX, int posY) {
		if(i.ile[posX][posY].getValeur()==16){
			i.ile[posX][posY].setValeur(8);		
		}		
		energie-=5;
	}
